    ...
    <view class="container">
        ...
        <block v-for="(item, index) in list" :key="index">
            <view class="list" v-if="item.category_uid == tab">
                <view class="item" :data-uid="good.goods_uid" @tap.stop.prevent="toDetail" v-for="(good, index1) in item.goods_list" :key="index1">
                    <view class="badge" :style="'background-color: ' + good.tag_arr[0].color + ';'">{{ good.tag_arr[0].tag_name }}！</view>
